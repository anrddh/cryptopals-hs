{-
 Source code for the SHA package available here:
 https://hackage.haskell.org/package/SHA

 For whatever reason, Stack wouldn't let me install it. To be clear,
 I'm _not_ the author of any of the code in this file. The original
 authors, as reported by Hackage are Adam Wick <awick@galois.com> and
